"""
Django settings for flower_shop_project project.
...
SECRET_KEY = 'django-insecure-(%y=(=rcndwn$%#9=7a@*ri%hfneptv)d#has_2c_uslfi084w'
...
ROOT_URLCONF = 'flower_shop_project.urls'
...
WSGI_APPLICATION = 'flower_shop_project.wsgi.application'
